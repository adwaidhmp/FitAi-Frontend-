...
import TrainerUserOverviewModal from "../trainer/TrainerUserOverviewModal";
            ...
            <>
              ...
              <div className="p-4 border-b border-gray-800 flex justify-between items-center">
                ...
                <div className="relative flex gap-2">
                  ...
                  {/* Dropdown */}
                  {showOptions && (
                    <div className="absolute right-0 top-12 w-48 bg-gray-900 border border-gray-700 rounded-xl shadow-xl z-50">
                      <button
                        onClick={() => {
                          setShowProfileModal(true);
                          setShowOptions(false);
                        }}
                        className="w-full flex items-center gap-3 px-4 py-3 text-sm text-white hover:bg-gray-800 rounded-t-xl"
                      >
                        <User size={16} />
                        View User Profile
                      </button>
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 text-sm text-white hover:bg-gray-800 rounded-b-xl"
                      >
                        <Video size={16} />
                        Start Video Call
                      </button>
